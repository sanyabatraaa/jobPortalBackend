...
export const postJob = catchAsyncErrors(async(req,res,next)=>{
    ...
    if(!title || !jobType || !location || !companyName || !responsibilities || !salary || !jobNiche || !qualifications){
        return next(Errorhandler("Please provide full job details",400))
    }

    if((personalWebsiteUrl && !personalWebsiteTitle)|| (personalWebsiteTitle && !personalWebsiteUrl)){
